...
class PuzzleOnBoardConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        ...
        await self.accept()
        print(f"PuzzleOnBoardConsumer: User {self.channel_name} connected to puzzle \
    ...
    async def disconnect(self, close_code):
        if hasattr(self, 'puzzle_instance_group_name'):
            ...
            print(f"PuzzleOnBoardConsumer: User {self.channel_name} disconnected from puzzle \
                  {self.game_id} on board {self.board_room_name}")
...
class WhiteboardConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        ...
        await self.accept()
        print(f"WhiteboardConsumer: Пользователь {self.channel_name} \
